    ...
    <CardContent>
      <form {...createProfile}>
        <div>
          <Label
            class={[
              !!createProfile.fields.line1.issues() && "text-destructive",
              "pb-2",
            ]}>line 1</Label
          >
          <Input
            {...createProfile.fields.line1.as("text")}
            aria-errormessage="{createProfile.fields.line1.as('text')
              .name}-error"
        ...
        <div>
          <Label
            class={[
              !!createProfile.fields.line2.issues() && "text-destructive",
              "pb-2",
            ]}>line 2</Label
          >
          <Input
            {...createProfile.fields.line2.as("text")}
            aria-errormessage="{createProfile.fields.line2.as('text')
              .name}-error"
